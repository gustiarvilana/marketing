            ...
            <div class="container">
                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown mx-sm-4 notification-dropdown notifications me-3">
                        <input class="form-control" type="text" id="range_periode" value="" />
    ...
    <script>
        ...
        function range_periode() {
            $('#range_periode').daterangepicker({
                ...
                var range_periode = {
                    start_periode: start.format('YYYYMMDD'),
                    end_periode: end.format('YYYYMMDD')
                };

                $.ajax({
                    url: "{{ route('add_session') }}", // Gantilah dengan route yang sesuai
                    type: "POST",
                    data: {
                        data: range_periode, // Mengirim data array sebagai parameter
